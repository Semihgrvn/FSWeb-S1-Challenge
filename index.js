...
(işlev yazmanıza gerek yok)
Fenomenler dizisinde bir yazım hatası var 😱 7. sıradaki fenomen 'Justin Bieber' ın soyismi 'Biber' olarak yanlış yazılmış. Bu sorunu düzeltin ve çalışmanızı kontrol etmek için
console.log() yapın.
*/
...
function indekseGoreFenomen(dizi,sayi) {
  const x= `${sayi}. indekste bulunan fenomen: ${dizi[sayi].profile}`;
  return x
}
...
function fenomenGonderimSayisi(fenonemler, name){
  for (let i=0; i< fenomenler.length; i++){
